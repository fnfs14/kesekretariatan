...
<div class="navbar navbar-inverse">
	<div class="container z0">
		<div class="navbar-header">
			<span class="navbar-brand" href="#">Master Derajat</span>
		</div>
	</div><!-- /.container -->
</div>
<?php foreach ($data_derajat as $value) {?>
<form action="<?php echo site_url('administrator/master_derajat/update/'.$value->id_master_derajat.'')?>" method="post" id="formnya">
			...
			<center>
				<table width="90%" class="table-form">
                    <tr>
                        ...
                        <td>
                            <div class="col-lg-6">
                                <input type="text" class="form-control col-md-2" id="jenis_derajat"
                                       name="jenis_derajat" value='<?php echo $value->derajat?>'>
                            </div>
                        </td>
                    </tr>
					<tr style="display:none;">
						<td>Isi Derajat</td>
						<td><div class="col-lg-6"><textarea style="width: 400px;" tabindex="9" id="isi_derajat"
                                                            name="isi_derajat"
                                                            class="form-control"><?php ?></textarea></div>
                            </td>
					</tr>
				</table>
...
<script>
	$('#proses').click(function(){
        var jenis_derajat = validate($("input[name='jenis_derajat']").val());
		if($("input[name='jenis_derajat']").val()==""){
			alert("Harap isi jenis derajat");
		}else if(jenis_derajat=="failed"){
