...
if(empty($bb)){
    ...
    echo "<script type='text/javascript'>alert('$bb');</script>";
}
?>
<?php echo $this->session->flashdata("k"); ?>
<form action="<?php echo base_URL() ?>administrator/master_tujuan/save" method="post" id="formnya">
    <div class="row-fluid well" style="overflow: hidden">
        <div class="col-lg-12">
            <center>
                <table width="90%" class="table-form">
                    <tr>
                        <td>Nama Asal Surat</td>
                        <td>
                            <div class="col-lg-6">
                    ...
                    <tr style="display:none;">
                        ...
                        <td>
                            <div class="col-lg-6"><textarea style="width: 400px;" tabindex="9" id="isi_nama"
                                                            name="isi_nama"
