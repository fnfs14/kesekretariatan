...
<div class="navbar navbar-inverse">
	...
	<div class="col-lg-6">
		<table width="100%" class="table-form">
			<tr>
				<td width="20%">Nama Satuan Kerja</td><td><b><input type="text" name="nama_satuan" required value="<?php echo $nama_satuan; ?>" style="width: 300px" class="form-control" tabindex="1" autofocus></b></td>
			</tr>
		</table>
