...
<div class="navbar navbar-inverse">
	<div class="container" style="z-index: 0">
		<div class="navbar-header">
			<span class="navbar-brand" href="#">Tambah Aksi</span>
		</div>
	</div><!-- /.container -->
</div><!-- /.navbar -->
	
	<form action="<?php echo base_URL(); ?>admin/aksi_simpan" method="post" accept-charset="utf-8" enctype="multipart/form-data">
	...
	<div class="col-lg-6">
		<table width="100%" class="table-form">
			...
			<tr>
				<td width="40%">Urutan</td><td><b><input type="text" name="urutan" value="<?php  // echo $re->urutan; ?>" style="width: 300px" class="form-control" tabindex="1" autofocus></b></td>
			</tr>
		</table>
		<br><br><br>
	</div>
