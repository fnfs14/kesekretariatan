...
if ($action == "edit_nota") {
	...
	$subbab[2]->id_bab = 1;
	$subbab[2]->judul =  "Ruang Lingkup";
	$subbab[2]->isi = "";
	$subbab[3] = new \stdClass();
	$subbab[3]->id_bab = 1;
	$subbab[3]->judul =  "Pengertian Umum";
	$subbab[3]->isi = "";
	$bab[1] = new \stdClass();
	$bab[1]->ID = 2;
	$bab[1]->judul = "PROSEDUR";
							        ...
							        <div class="dynamic_field col-xs-10">
									    ...
									    <div class="form-group template hide">
										    ...
										    <div class="form-group col-xs-12">
										        ...
										        <label class="col-xs-1">Isi SubBab</label>
										        <div class="col-xs-10">
										        	<textarea name="isi_subbab<?php echo '['.$key.']' ?>[]" id="isi_subbab<?php echo '['.$key.']' ?>[]" class="form-control editor-field" rows="5"></textarea>
										        </div>
									        </div>
									    </div>
									</div>
