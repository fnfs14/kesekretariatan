			...
			<tr>
				...
				<td class="ctr aksi">
					<?php if ($b->flag == 'ASSIGNED') { ?>
						<div class="btn-group">
							<a data-toggle="modal" href="#view" class="btn btn-info btn-sm viewNota" data-id="<?php echo $b->ID?>"><i class="icon-zoom-in icon-white"> </i>Lihat Permintaan</a><!--ubah mei bahasa-->
							<a href="<?php echo base_URL(); ?>admin/nota_dinas/entry/create_nota/<?php echo $b->ID; ?>" class="btn btn-warning btn-sm"><i class="icon-pencil icon-white"> </i>Buat</a><!--ubah mei bahasa-->
						</div>
					<?php } else if ($b->flag == 'WORKED ON' || $b->flag == 'PULLED BACK') {?>
						<div class="btn-group">
							...
							<a data-toggle="modal" href="#preview" class="btn btn-primary btn-sm previewNota" data-id="<?php echo $b->ID?>"><i class="icon-zoom-in icon-white"> </i>Lihat Nota</a><!--ubah mei bahasa-->
							<a href="<?php echo base_URL(); ?>admin/nota_dinas/act/finalize_nota/<?php echo $b->ID?>" class="btn btn-success btn-sm"><i class="icon-share-alt icon-white"> </i>Selesai</a><!--ubah mei bahasa-->
						</div>
					<?php } else if ($b->flag == 'COMPLETED') {?>
						<div class="btn-group">
							<a data-toggle="modal" href="#view" class="btn btn-info btn-sm viewNota" data-id="<?php echo $b->ID?>"><i class="icon-zoom-in icon-white"> </i>Lihat Permintaan</a>
							<a href="<?php echo base_URL(); ?>admin/nota_dinas/act/pullback/<?php echo $b->ID?>" class="btn btn-warning btn-sm"><i class="icon-arrow-left icon-white"></i>Tarik Kembali</a><!--ubah mei bahasa-->
