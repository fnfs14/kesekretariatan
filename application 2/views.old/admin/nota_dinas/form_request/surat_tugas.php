...
<div class='request_surat_tugas'>
		...
		<div class="dynamic_field">
		    <div class="form-group row">
		    	<label class="col-xs-1">Tugas</label>
		        <div class="col-xs-7"> 
		            <button type="button" class="btn btn-default addButton col-xs-12" tabindex="1" autofocus><b>+</b></button>
		        </div>
		    </div>
		    ...
		    <?php foreach ($tugas as $value) { ?>
			    <div class="form-group clone">
			        ...
			        <div class="col-xs-6">
			        	<textarea name="tugas[]" class="form-control" tabindex="1" autofocus placeholder="Tugas..."><?php echo $value->isi?></textarea>
			        </div>
			    </div>
		    <?php } ?>
		    ...
		    <div class="form-group template hide">
		        ...
		        <div class="col-xs-6">
		        	<textarea name="tugas[]" class="form-control" tabindex="1" autofocus placeholder="Tugas..."></textarea>
		        </div>
		    </div>
		</div>
