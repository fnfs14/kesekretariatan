...
<div class="navbar navbar-inverse">
	...
	<div class="col-lg-6">
		...
		<a href="<?php echo base_URL(); ?>admin/surat_disposisi/<?php echo $this->uri->segment(3); ?>" tabindex="7" class="btn btn-success"><i class="icon icon-arrow-left icon-white"></i> Kembali</a>
		</td></tr>
		</table>
	</div>
