    ...
    <body onload="window.print()"><!--  -->
        <table id="main">
			...
			<tr class="fourth">
				...
				SALINAN <br> KEPUTUSAN KEPALA PUSHIDROSAL<br>
			...
			<tr class="third">
                ...
                <td>
                    <table>
                        <tr>
                            <td>Ditetapkan di Jakarta<br>pada tanggal <?=$q->tgl_surat;?></td>
                            <td><hr></td>
                        </tr>
                        <tr>
        ...
        <table id="second">
                ...
                <td>
                    <table>
                        <tr>
                            ...
                            <td>
                                <p>Untuk Salinan Sesuai Aslinya</p>
                                <br><br>
								Kepala Setum Pushidrosal
                                <p>Muddan Zayadi,S.Si  <br> Letkol Laut(KH)NRP.13100/P</p>
                            </td>
                        </tr>
                    </table>
                </td>
			...
			<tr class="fourth">
                <td colspan="2"> Distribusi: <br><?= $q->kepadanya; ?></td>
			</tr>
        </table>
    </body>
</html>