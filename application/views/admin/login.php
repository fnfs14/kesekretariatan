...
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <title>Kesekretariatan Online</title>
...
.body{
	...
	width: auto;
	height: auto;
	background-image: url('../aset/img/bglogin.jpg');
...
<div class="header">
		<div>
			<img src="<?= base_url(); ?>aset/img/pushidros.png" width="100px" />
			<br/>
			<b>KESEKRETARIATAN <span class="txt-blue">ONLINE</span></b>
			<br/>
			<br/>
			<b>LOG IN</b>
		</div>
