...
<div class="navbar navbar-inverse">
	<div class="container z0">
		<div class="navbar-header">
			<span class="navbar-brand" href="#">Master Asal Surat</span>
		</div>
	</div><!-- /.container -->
</div>
<?php foreach ($data_nama as $value) {?>
<form action="<?php echo site_url('administrator/master_tujuan/update/'.$value->id.'')?>" method="post" id="formnya">
			...
			<center>
				<table width="90%" class="table-form">
                    <tr>
                        ...
                        <td>
                            <div class="col-lg-6">
                                <input type="text" class="form-control col-md-2" id="jenis_nama"
                                       name="jenis_nama" value='<?php echo $value->nama?>'>
                            </div>
                        </td>
                    </tr>
					<tr style="display:none;">
						<td>Isi Asal Surat</td>
...
<script>
	$('#proses').click(function(){
        var jenis_nama = validate($("input[name='jenis_nama']").val());
		if($("input[name='jenis_nama']").val()==""){
			alert("Harap isi nama");
		}else if(jenis_nama=="failed"){
