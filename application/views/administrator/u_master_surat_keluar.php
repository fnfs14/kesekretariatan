...
<?php foreach ($data_surat_keluar as $value) {?>
<form action="<?php echo site_url('administrator/master_surat_keluar/update/'.$value->id_master_surat_keluar.'')?>" method="post" id="formnya">
                        ...
                        <td>
                            <div class="col-lg-6">
                                <input type="text" class="form-control col-md-2" id="jenis_surat_keluar"
                                       name="jenis_surat_keluar" value='<?php echo $value->jenis_surat_keluar?>'>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="col-lg-6">
                                <input type="text" class="form-control col-md-2" id="format_surat_keluar"
                                       name="format_surat_keluar" value='<?php echo $value->format_surat_keluar?>'>
                            </div>
                        </td>
                    </tr>
					<tr>
						<td>Isi Surat Keluar</td>
						<td><div class="col-lg-6"><textarea style="width: 400px;" tabindex="9" id="isi_surat_keluar"
                                                            name="isi_surat_keluar"
                                                            class="form-control"><?php echo $value->isi_surat_keluar?></textarea></div>
                            </td>
					</tr>
				</table>
