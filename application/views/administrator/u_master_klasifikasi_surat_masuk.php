...
<form action="<?php echo site_url('administrator/master_klasifikasi_surat_masuk/update/'.$value->id_master_klasifikasi_surat_masuk.'')?>" method="post" id="formnya">
                        ...
                        <td>
                            <div class="col-lg-6">
                                <input type="text" class="form-control col-md-2" id="jenis_surat_masuk"
                                       name="jenis_surat_masuk" value='<?php echo $value->klasifikasi_surat_masuk?>'>
                            </div>
                        </td>
                    </tr>
