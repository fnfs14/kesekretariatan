...
<form action="<?php echo base_URL() ?>administrator/master_derajat/save" method="post" id="formnya">
            ...
            <center>
                <table width="90%" class="table-form">
                    ...
                    <tr style="display:none;">
                        <td>Isi Derajat</td>
                        <td>
                            <div class="col-lg-6"><textarea style="width: 400px;" tabindex="9" id="isi_derajat"
                                                            name="isi_derajat"
