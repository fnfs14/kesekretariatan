            ...
            <center>
                <table width="90%" class="table-form">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="col-lg-5">
								<input type="text" id="agenda" class="form-control" name="agenda" required>
                            </div>
                            <div class="col-lg-1">
								<a class="btn btn-primary btn-md" id="check_agenda"><span class="icon-search icon-white"></span></a>
                            </div>
					...
					<tr>
						<td colspan="2"><hr style="border-color: #eee8e8;"/></td>
					</tr>
                    <tr>
                        <td>Ruang</td>
                        <td>
                ...
                <div style="float:right;margin-right: 80px;">
                    <a href="#" class="btn btn-primary" tabindex="13" id="proses" disabled><i
                                    class="icon icon-ok icon-white"></i> Simpan</a>
                    <a href="<?php echo base_URL(); ?>administrator/master_arsip_surat/m_arsip_surat" class="btn btn-success" tabindex="8" ><i class="icon icon-arrow-left icon-white"></i> Kembali</a>
                </div>
        </div>
    </div>
</form>
<script>
    $('#proses').click(function () {
		if($("#agenda").val()=="" || $("#ruang").val()=="" || $("#lemari").val()=="" || $("#rak").val()=="" || $("#box").val()==""){
